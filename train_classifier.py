...
def home():
    # Load training data
    training_data = load_training_data('data/InsertDatabaseName.db')  # Path to your database
...
def predict():
    ...
    return render_template('index.html', training_overview_graph=create_training_overview_plot(load_training_data('data/InsertDatabaseName.db')), categories=categories, prediction=prediction_dict)
